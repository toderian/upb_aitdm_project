"""
Centralized Model Evaluation Script for Stage 1
COVIDx CXR-4 Binary Classification (COVID Positive/Negative)

Usage:
    python evaluation/evaluate_centralized.py --model_path models/best_centralized.pth

Results are saved to: evaluation/results/stage1/centralized/
"""
...
class ModelEvaluator:
    ...
    def evaluate(self, data_loader, output_dir: str = None, model_name: str = "centralized"):
        """
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate centralized COVIDx model')
    parser.add_argument('--model_path', type=str, default='models/best_centralized.pth',
                        help='Path to model checkpoint')
    parser.add_argument('--data_dir', type=str, default='dataset/archive',
                        help='Path to extracted dataset directory')
    parser.add_argument('--output_dir', type=str, default='evaluation/results/stage1/centralized',
